...
def main():
    ...
    parser.add_argument('--priority','-p',default="spikein_small,univec,rRNA,miRNA,lncRNA,mRNA,piRNA,snoRNA,snRNA,srpRNA,tRNA,tucpRNA,Y_RNA,circRNA,genome",help="Priority of mapping")
